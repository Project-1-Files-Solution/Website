...
if (isset($_GET['view'])) {
    ...
    $file_url = FM_ROOT_URL . fm_convert_win((FM_PATH != '' ? '/' . FM_PATH : '') . '/Data/' . $file);
    $file_path = $path . '/' . $file;
...
if (isset($_GET['chmod']) && !FM_READONLY && !FM_IS_WIN) {
    ...
    $file_url = FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/Data/' . $file;
    $file_path = $path . '/' . $file;
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <ul class="list-inline footer-action" style="margin-left:400px;">
                ...
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right <?php echo fm_get_theme(); ?>" aria-labelledby="navbarDropdownMenuLink-5">
                            ...
                            <a title="<?php echo lng('Logout') ?>" class="dropdown-item nav-link" href="../welcome.php"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Logout') ?></a>   </div>
                    </li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
                            <li class="nav-item">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'File Management System'; $tr['en']['AppTitle']           = 'File Manager';
    ...
    $tr['en']['NewItem']        = 'Add';                    $tr['en']['Folder']             = 'Folder';
    $tr['en']['Delete']         = 'Delete';                 $tr['en']['Rename']             = 'Rename';
    $tr['en']['CopyTo']         = 'Copy to';                $tr['en']['DirectLink']         = 'Direct link';
    $tr['en']['UploadingFiles'] = 'Upload Files';           $tr['en']['ChangePermissions']  = 'Change Permissions';
    $tr['en']['Copying']        = 'Copying';                $tr['en']['CreateNewItem']      = 'Create File/Folder';
    $tr['en']['Name']           = 'Name';                   $tr['en']['AdvancedEditor']     = 'Advanced Editor';
    $tr['en']['RememberMe']     = 'Remember Me';            $tr['en']['Actions']            = 'Actions';
    $tr['en']['Upload']         = 'Upload';                 $tr['en']['Cancel']             = 'Cancel';
    $tr['en']['InvertSelection']= 'Invert Selection';       $tr['en']['DestinationFolder']  = 'Destination Folder';
    $tr['en']['ItemType']       = 'Select File/Folder';     $tr['en']['ItemName']           = 'File/Folder Name';
    $tr['en']['CreateNow']      = 'Add';                    $tr['en']['Download']           = 'Download';
